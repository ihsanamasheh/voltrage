...
import chocolateIsolateAsset from "@/assets/Chocolate_Whey_Protein_Isolate.jpeg.asset.json";
...
export const productMedia: Record<string, Media> = {
  "Fresh Strawberry (5 lbs)": { src: strawberryWheyAsset.url, width: 976, height: 1084 },
